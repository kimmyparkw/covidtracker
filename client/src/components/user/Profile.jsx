    ...
    render() {
        return (
            ...
            <h1>{`Welcome Back, ${this.props.user.username}!`}</h1> <h3><a href={`/user/profile/${this.props.user.id}`}>Edit User Profile</a></h3>
            {
                    ...
                    <HistoricalChart key={stateData[index].hash} delete={this.props.delete} fullName={this.props.fullName} stateName={stateData[index].state} chartData={stateData} usData={this.props.usData} usDaily={this.props.usDaily} usWeek={this.props.usWeek} usMonth={this.props.usMonth}/>
